...
@Composable
fun MyDrawer(scope: CoroutineScope, state: ScaffoldState, navHostController: NavHostController) {
    ...
    Box {
        Column {
            ...
            Text(
                text = auth.currentUser?.displayName ?: "Not Provided",
            ...
            Text(
                text = auth.currentUser?.email ?: "Not Provided",
